...
def computeTidalConstituents(signal):
    ...
    dates = np.array([timeArray.epochToDatetime(t)
                      for t in signal.time.asEpoch().array])
    ...
    (tap.zeta, tap.nu, tap.nup, tap.nupp, tap.kap_p, tap.ii, tap.R,
     tap.Q, tap.T, tap.jd, tap.s, tap.h, tap.N, tap.p, tap.p1) = package
    ...
    if tap.zero_ts:
        ...
        tap.dates_filled, tap.elevation_filled = tap.missing(
            'fill', tap.dates, tap.elevation)
        ...
        (tap.zeta, tap.nu, tap.nup, tap.nupp, tap.kap_p, tap.ii, tap.R,
         tap.Q, tap.T, tap.jd, tap.s, tap.h, tap.N, tap.p, tap.p1) = package
        (tap.speed_dict, tap.key_list) = tap.which_constituents(
            len(tap.dates), package, rayleigh_comp=ray)
    tap.constituents()
...
class tidalConstituents(object):
    ...
    def computeFromData(cls, dc):
        ...
        t = dc.time
        return cls(dc.description, amp, pha, dc.fieldNames[
                   0], t.getDatetime(0), t.getDatetime(-1))
