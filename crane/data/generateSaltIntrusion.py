...
def computeSaltIntrusion(transectDC, salt_threshold_list):
    ...
    for it in range(nTime):
        ...
        Xalong, Z, salt, time, uniqueXYCoords = transectPlot.generateTransectFromDataContainer(
            transectDC, it)
        Xalong = Xalong[0, :]
        ...
        for i, salt_threshold in enumerate(salt_threshold_list):
            ...
            if binaryIx[-1]:  # whole transect is within threshold
                ...
                x_threshold = interp1d(
                    maxSalt[[thIx + 1, thIx]],
                    Xalong[[thIx + 1, thIx]])(salt_threshold)
