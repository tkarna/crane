...
#'psi1': [1, 'AAAZZYA', [1, 1, 1, 0, 0, -1, 1]],
        ...
        if num_hours < 13:
            ...
            #sys.exit()
            raise Exception("Cannot calculate any constituents from this record length")
...
class tappy(Util):
    ...
    def missing(self, task, dates, elev):
        ...
        if np.any(interval > datetime.timedelta(seconds = 3600)):
            if task == 'fail':
                ...
                #sys.exit() # HACK
                raise Exception( "There is a difference of greater than one hour between values" )
    ...
    def constituents(self):
        ...
        if np.any(difference < datetime.timedelta(seconds = 0)):
            ...
            #sys.exit() # HACK
            raise Exception( "The date values reverse - they must be constantly increasing." )
